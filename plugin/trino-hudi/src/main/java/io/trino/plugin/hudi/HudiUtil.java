...
public final class HudiUtil
{
    ...
    public static HoodieTableType getTableType(String inputFormat)
    {
        switch (inputFormat) {
            ...
            default:
                throw new TrinoException(HUDI_UNKNOWN_TABLE_TYPE, "Unknown table type for input format: " + inputFormat);
        }
    }
